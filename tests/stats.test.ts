    ...
    return {
      ...
      analytics: {
        metrics: [
          [
            'file:/src/index.ts',
            { fanIn: 0, fanOut: 2, instability: 1, coupling: 2, loc: 50, complexity: 3, maintainability: 80, churn: 5, heat: 0.4 },
          ],
          [
            'file:/src/app.ts',
            { fanIn: 1, fanOut: 2, instability: 0.666, coupling: 3, loc: 120, complexity: 8, maintainability: 65, churn: 12, heat: 0.7 },
          ],
          [
            'file:/src/utils.ts',
            { fanIn: 2, fanOut: 0, instability: 0, coupling: 2, loc: 80, complexity: 2, maintainability: 90, churn: 3, heat: 0.2 },
          ],
          [
            'file:/src/helper.py',
            { fanIn: 0, fanOut: 0, instability: 0, coupling: 0, loc: 30, complexity: 1, maintainability: 95, churn: 0, heat: 0.0 },
          ],
        ],
        hubs: [
      ...
      cycles: [
        { nodes: ['file:/src/a.ts', 'file:/src/b.ts'], edgeKind: 'imports' },
      ],
      cycleCount: 1,
      git: {
